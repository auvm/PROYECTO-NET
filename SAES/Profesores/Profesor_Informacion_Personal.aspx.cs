...
namespace SAES.Profesores
{
    public partial class Profesor_Profesor : System.Web.UI.Page
    {
        ...
        protected void lbInfoPersonal_Click(object sender, EventArgs e)
        {
            ...
            imgPerfil.ImageUrl = @"../Imagenes-BorrarAlFinal/fotoHombre.PNG";
            imgPerfil.Width = 100;
        ...
        protected void lbGrupos_Click(object sender, EventArgs e)
        {
            Label lblTitulo = new Label();
